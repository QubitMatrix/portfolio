...
export default function About(
    ...
    const structure = [
        ...
        { 
            ...
            display: about.competitions.display,
            items: about.competitions.participations.map(participation => participation.name)
        },
        { 
                    ...
                    { about.competitions.display && (
                        <>
                            ...
                            <Flex
                                direction="column"
                                fillWidth gap="l" marginBottom="40">
                                {about.competitions.participations.map((participation, index) => (
                                    <Flex
                                        key={`${participation.name}-${index}`}
                                        fillWidth gap="4"
                                        direction="column">
                                        <Text
